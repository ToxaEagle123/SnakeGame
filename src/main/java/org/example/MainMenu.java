...
public class MainMenu extends JPanel {
    ...
    public MainMenu(GameFrame frame) {
        ...
        JButton highscoreButton = new JButton(new ImageIcon(Assets.highscoreButton));
        highscoreButton.setBorderPainted(false);
        highscoreButton.setContentAreaFilled(false);
        highscoreButton.setFocusPainted(false);
        highscoreButton.setOpaque(false);
        highscoreButton.setBounds(200, 250, 200, 50);
        highscoreButton.addActionListener((ActionEvent e) -> gameFrame.showHighscores());
        add(highscoreButton);
